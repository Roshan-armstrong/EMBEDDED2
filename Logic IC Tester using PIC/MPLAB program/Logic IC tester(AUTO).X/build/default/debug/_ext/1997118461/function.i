...
# 4 "../PIC_AUTO.X/function.c" 2

# 1 "../PIC_AUTO.X/config.h" 1
...
# 22 "../PIC_AUTO.X/config.h" 2
# 5 "../PIC_AUTO.X/function.c" 2

# 1 "../PIC_AUTO.X/lcd.h" 1
# 18 "../PIC_AUTO.X/lcd.h"
void LCD_Init();
void LCD_Clear();
void LCD_SL();
...
# 6 "../PIC_AUTO.X/function.c" 2

# 1 "../PIC_AUTO.X/function.h" 1
# 1 "../PIC_AUTO.X/lcd.h" 1
# 18 "../PIC_AUTO.X/lcd.h"
void LCD_Init();
void LCD_Clear();
...
void Auto(void);
void gate_1(void);
extern const char name[7][5];
extern unsigned int n;
# 7 "../PIC_AUTO.X/function.c" 2
